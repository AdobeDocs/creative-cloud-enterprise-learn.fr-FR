...
* [**Génération de caractères cohérente**](/help/firefly/graph/templates/character-gen.md) : dans le modèle de graphique, vous chargez une image de référence d’un caractère, puis vous permutez la scène ou l’invite de pose pour chaque nouvelle prise de vue. La référence de caractère reste verrouillée lorsque la scène environnante change.
