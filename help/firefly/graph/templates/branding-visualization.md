---
title: Visualisation du branding
description: Apprenez à visualiser votre logo ou votre marque dans les scènes de produit
...
# Visualisation du branding

Apprenez à visualiser votre logo ou votre marque dans les scènes de produit. Ajoutez des directives de marque pour un logo et une palette de couleurs et le graphique produit des illustrations statiques et une courte passe de mouvement en une seule fois, de sorte que les deux formats restent visuellement alignés.[Ouvrez le modèle de visualisation de branding](https://firefly.adobe.com/graph/edit/id/urn:aaid:sc:US:c11ecbe0-0751-58ce-9f30-2eb6518bfd51).
